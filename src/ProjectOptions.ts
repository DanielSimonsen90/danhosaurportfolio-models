...
export type ProjectTypeCSharp = 
    ProjectOptionASPNetCore | 
    ProjectOptionConsole | 
    ProjectOptionLibrary | 
    ProjectOptionWindowsForms | 
    ProjectOptionWPF;

export type ProjectTypeJavaScript = 
    ProjectOptionNodejs | 
    ProjectOptionWebsite | 
    ProjectOptionConsole;

export type ProjectTypeTypeScript = 
    ProjectOptionNodejs | 
    ProjectOptionWebsite | 
    ProjectOptionLibrary;

export type ProjectTypeWebsite = 
    ProjectOptionNodejs | 
    ProjectOptionWebsite | 
    ProjectOptionASPNetCore;
